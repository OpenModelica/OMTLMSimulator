...
\documentclass[a4paper,12pt]{include/opencpsreport}
%\usepackage{inputenc} 
...
\linenumbers
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Document variables that need to be set
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\reportnumber{D2.4}
\reporttitle{Wrapper for FMI in TLM-based Asynchronous Co-Simulation}
\shortreporttitle{Wrapper for FMI in TLM-based Co-simulation}  % Title appearing at right side of header

%%% Set document release class as appropriate
%%% Access classification as per definitions in PCA;
%%% PU = Public, CO = Confidential.
%%% Access classification per deliverable stated in FPP
\reportaccess{PU}

%%% Deliverable type according to FPP, note that all non-report deliverables
%%% must be accompanied by a deliverable report.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Definition of Deliverable Contributors and History
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\deliverableContributors{
  \renewcommand{\arraystretch}{1.3} % increase space between rows
  \textbf{\sffamily Deliverable Contributors:}
  \begin{center}
    ...
    \begin{tabularx}{\linewidth}[h!]{p{2.2cm}|X|p{3.8cm}|p{2.4cm}|p{1.4cm}|}
    \hhline{~----}
    & \cellcolor[gray]{0.95}Name &
      \cellcolor[gray]{0.95}Organisation &
      \cellcolor[gray]{0.95}Primary role in project &
      \cellcolor[gray]{0.95}Main \mbox{Author(s)}\footnote{\scriptsize Indicate Main Author(s) with an “X” in this column.}\\
    \hline
    \multicolumn{1}{|p{2.2cm}|}{\cellcolor[gray]{0.95}Deliverable Leader\footnote{\scriptsize Deliverable leader according to FPP, role definition in PCA.}} &
      Robert Braun & SICS East Swedish ICT & T2.4 member  & \centerline X\\
    \hline
    %%% CONTRIBUTING AUTHOR(s)
    \multicolumn{1}{|p{2.2cm}|}{\cellcolor[gray]{0.95}} &
       & &  & \\
    \cline{2-5}
    \multicolumn{1}{|p{2.2cm}|}{\cellcolor[gray]{0.95}} &
      & & & \\
    ...
    \multicolumn{1}{|p{2.2cm}|}{\cellcolor[gray]{0.95}} &
      & & & \\
    \cline{2-5}
    \multicolumn{1}{|p{2.2cm}|}{\cellcolor[gray]{0.95}\multirow{-4}{2.2cm}{Contributing Author(s)\footnote{\scriptsize Person(s) from contributing partners for the deliverable, expected contributing partners stated in FPP.}}} &
      & & & \\
    \hline
    %%% INTERNAL REVIEWERS
    \multicolumn{1}{|p{2.2cm}|}{\cellcolor[gray]{0.95}} &
      Dag Fritzson & SKF & T2.4 member & \\
    \cline{2-5}
    \multicolumn{1}{|p{2.2cm}|}{\cellcolor[gray]{0.95}} &
    ...
    \multicolumn{1}{|p{2.2cm}|}{\cellcolor[gray]{0.95}} &
      & & & \\
    \cline{2-5}
    \multicolumn{1}{|p{2.2cm}|}{\cellcolor[gray]{0.95}\multirow{-4}{2.2cm}{Internal Reviewer(s)\footnote{\scriptsize Typically person(s) with appropriate expertise to assess deliverable structure and quality.}}} &
      & & & \\
    \hline
    \end{tabularx}
  \end{center}
...
\def\deliverableHistory{
 \renewcommand{\arraystretch}{1.3} % increase space between rows

 \textbf{\sffamily Document History:}
 \begin{center}
 \footnotesize\sffamily
 \begin{tabularx}{\linewidth}[h!]{| l | l | X | l |}
 \rowcolor[gray]{.95}\hline
 Version & Date & Reason for change & Status\footnote{\scriptsize Status = “Draft”, “In Review”, “Released”.}\\
 \hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Additional packages to be used in the document
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%% Bibliography
% Prefer biblatex because: (a) supports an ``alpha'' like citation style, (b) supports DOIs and URLs
% However, requires biber to be installed. Not all may have it, so we introduce a flag:
\usepackage{ifthen}
\newboolean{HaveBiber} \setboolean{HaveBiber}{false}
\ifthenelse{\boolean{HaveBiber}}{
\usepackage[backend=biber,style=alphabetic,natbib=true]{biblatex}
\addbibresource{example-report.bib} % Add the biblatex file
}{}
...
\begin{tabbing}
\textbf{Abbreviation}$\quad$ \= \textbf{Definition}\\
...
\clearpage
\ifthenelse{\boolean{HaveBiber}}{
\printbibliography % Use biblatex instead of old bibtex
}{ % Use bibtex
\bibliographystyle{alphaurl} % Use an http://nxg.me.uk/dist/urlbst/ enabled hyperref version of ``alpha''
