...
class TLMClientComm {
 ...
 public:
    ...
    //! to be sent to the TLM manager
    void CreateInterfaceRegMessage(std::string& Name, InterfaceDimensionality dimensionality, InterfaceCausality causality, InterfaceDomain domain, TLMMessage& mess);
