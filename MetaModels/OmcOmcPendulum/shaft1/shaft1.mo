model shaft1
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyCylinder bodycylinder1(r_shape = {0,0,0.5}) annotation(Placement(visible = true, transformation(origin = {49.2611,77.8325}, extent = {{-12,-12},{12,12}}, rotation = 0)));
