...
static const int notationOrder1const[]={0,1,2,3,1,2,1};
static const int notationOrder2const[]={0,1,2,3,2,3,3};
//! Accepts a number from 1 to 6, returns the first component of pair in  11,22,33,12,23,13
int double33s::notationOrder1(int internalOrder){
    assert(internalOrder>=1);
    assert(internalOrder<=6);
    return notationOrder1const[internalOrder];
}

//! Accepts a number from 1 to 6, returns the second component of pair in  11,22,33,12,23,13
int double33s::notationOrder2(int internalOrder){
    assert(internalOrder>=1);
    assert(internalOrder<=6);
    return notationOrder2const[internalOrder];
}
