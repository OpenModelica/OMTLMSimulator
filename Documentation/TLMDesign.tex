...
\begin{center}
	...
	\node[thick,draw,rectangle,
	      ...
	      text width=3*\dx] (a) {+ SimulationParams()\\+ Set()\\+ GetPort()\\+ SetPort()\\+ GetMonitorPort()\\+ SetMonitorPort()\\ + GetStartTimeStr()\\+ SetStartTimeStr()\\+ GetEndTimeStr()\\+ SetEndTimeStr()\\+ GetServerName()\\+ GetTimeout()};	
	...
	\node[thick,draw,rectangle,
	      ...
	      font=\sffamily\tiny,
	      yshift=-7.5*\dx,
	      text width=4.2*\dx] (b) {CompositeModel};
	\node[thick,draw,rectangle,
	      minimum width=3.3*\dx,
	      minimum height=1.5*\dx,
	      font=\sffamily\tiny,
	      yshift=-8.54*\dx,align=left,
	      text width=4.2*\dx] () {- Components\\- Interfaces\\- Connections\\- SimParams};
	\node[thick,draw,rectangle,
	      minimum width=3.3*\dx,
	      minimum height=5.5*\dx,
	      font=\sffamily\tiny,
	      yshift=-12.04*\dx,align=left,
	      text width=4.2*\dx] (c) {+ CompositeModel()\\+ \texttt{\textasciitilde}CompositeModel()\\+ RegisterTLMComponentProxy()\\+ GetTLMComponentProxy()\\+ GetComponentsNum()\\+ GetInterfacesNum()\\ + GetTLMComponentID()\\+ GetTLMInterfaceID()\\+ RegisterTLMInterfaceProxy()\\+ GetTLMInterfaceProxy()\\+ GetTLMInterfaceID()\\+ RegisterTLMConnection()\\+ GetTLMConnection()\\+ StartComponents()\\+ GetSimParams()\\+ CheckProxyComm()\\+ Print()};	
